                    ...
                    {activeTab === 'Dashboard' && (() => {
                        ...
                        return (
                            <div style={{display: 'flex', flexDirection: 'column', gap: '1.5rem'}}>
                                ...
                                <div className="card sketch-border" style={{background: 'linear-gradient(135deg, rgba(37,99,235,0.05) 0%, rgba(37,99,235,0.15) 100%)', display: 'flex', flexDirection: 'column', gap: '1rem'}}>
                                    <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                                        <div>
